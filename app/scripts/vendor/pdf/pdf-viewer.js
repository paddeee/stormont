...
var DEFAULT_URL = 'http://localhost:3000/test.pdf';
...
PDFJS.workerSrc = './scripts/vendor/pdf/pdf-worker.js';
...
function webViewerInitialized($pdfViewerElement) {
  ...
  var file = window.app.appConfig.getSourcePath() + $pdfViewerElement.pdfObject.Src;
...
window.addEventListener('updateviewarea', function (evt) {
  ...
  // ToDo: Re-add if we need Bookmark functionality
